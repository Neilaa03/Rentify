      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.page}>
          <View style={styles.header}>
            ...
            <Badge label={agency.verificationStatus || 'PENDING'} toneKey={agency.verificationStatus === 'VERIFIED' ? 'green' : agency.verificationStatus === 'REJECTED' ? 'red' : 'amber'} />
          </View>
          ...
          {state.loading ? (
            ...
            >
              ...
              <AgencyCard style={styles.card}>
                <SectionTitle kicker="DOSSIER" title="Complétion du dossier" subtitle={`${verifiedDocs}/${Math.max(1, documentTotal)} documents vérifiés`} />
                <View style={styles.progressTrack}>
                  <View style={[styles.progressFill, { width: `${Math.max(4, completion)}%` }]} />
                </View>
                <Text style={styles.progressCaption}>{completion}% complété</Text>
              </AgencyCard>
