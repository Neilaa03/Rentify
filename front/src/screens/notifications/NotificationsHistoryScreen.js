...
'../../services/notifications';import { useTranslation } from "react-i18next";
...
const NotificationsHistoryScreen = ({ navigation }) => {const { t } = useTranslation();
  ...
  const handleDelete = async (notification) => {
    Alert.alert(t("screens.notifications.notificationshistoryscreen.supprimer"), t("screens.notifications.notificationshistoryscreen.masquerCetteNotification"), [
    ...
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.screenTitle}>{t("screens.notifications.notificationshistoryscreen.historique")}</Text>
        ...
        <FlatList
          ...
          <View style={styles.emptyState}>
                <Text style={styles.emptyTitle}>{t("screens.notifications.notificationshistoryscreen.aucuneNotification")}</Text>
                <Text style={styles.emptySubtitle}>{t("screens.notifications.notificationshistoryscreen.rienAAfficher")}</Text>
              </View>
          }
