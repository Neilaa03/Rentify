...
const LIGHT = {
  ...
  colors: {
    ...BRAND_COLORS,
    background: '#F5F7FF',
    backgroundAlt: '#EBF0FF',
    surface: 'rgba(255,255,255,0.82)',
    surfaceStrong: '#FFFFFF',
    surfaceElevated: '#EEF2FF',
    card: '#FFFFFF',
    cardBorder: 'rgba(93, 103, 163, 0.18)',
    border: 'rgba(93, 103, 163, 0.18)',
    text: '#11162B',
    textMuted: '#5D678E',
    textSoft: '#394268',
    icon: '#5A6387',
    overlay: 'rgba(245, 247, 255, 0.66)',
    overlaySoft: 'rgba(245, 247, 255, 0.28)',
    modalBackdrop: 'rgba(14, 18, 40, 0.42)',
    inputBackground: 'rgba(255,255,255,0.96)',
    inputBorder: 'rgba(93, 103, 163, 0.22)',
    tabBar: 'rgba(255,255,255,0.94)',
    tabBarBorder: 'rgba(93, 103, 163, 0.12)',
    shadow: '#8790B6',
    white: '#FFFFFF',
  },
};
